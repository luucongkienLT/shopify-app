...
function DateRangePicker() {
  ...
  const ranges = [
    ...
    },
    {
      ...
      alias: "last1month",
      period: {
        since: new Date(new Date().setMonth(today.getMonth() - 1)),
        until: yesterday,
      },
    },
    {
      ...
      alias: "last3months",
      period: {
        since: new Date(new Date().setMonth(today.getMonth() - 3)),
        until: yesterday,
      },
    },
    {
      ...
      alias: "last6months",
      period: {
        since: new Date(new Date().setMonth(today.getMonth() - 6)),
        until: yesterday,
      },
    },
    {
      ...
      alias: "last1year",
      period: {
        since: new Date(new Date().setFullYear(today.getFullYear() - 1)),
        until: yesterday,
      },
    },
  ];
  ...
  function apply() {
    console.log("From:", formatDate(activeDateRange.period.since));
    console.log("To:", formatDate(activeDateRange.period.until));
